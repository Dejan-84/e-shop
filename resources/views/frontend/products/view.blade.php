   ...
   <div class="py-3 mb-4 shadow-sm bg-warning border-top">
        <div class="container">
            <h6 class="mb-0">
                ...
                <a href="{{ url('category/'.$products->category->slug) }}" class="text-dark">
                    {{ $products->category->name}}
                </a> /
                <a href="{{ url('category/'.$products->category->slug.'/'.$products->slug) }}" class="text-dark">
                    {{ $products->name}}
                </a>
            </h6>
        </div>
            ...
            <div class="">
                <div class="row mt-2">
                    <div class="col-md-4 border-right">
                        <img src="{{ asset('assets/uploads/products/'.$products->image)}}" class="w-100 mt-2" alt="">
                    </div>
                    <div class="col-md-8">
                        <h2 class="mb-0">
                            {{$products->name}}
